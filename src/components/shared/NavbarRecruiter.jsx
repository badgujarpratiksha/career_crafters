                    ...
                    </ul>
                    {
                        !user ? (
                            <div className='flex items-center gap-2'>
                                <Link to="/loginrecruiter"><Button variant="outline">Login</Button></Link>
                                <Link to="/signuprecruiter"><Button className="bg-[#6A38C2] hover:bg-[#5b30a6]">Signup</Button></Link>
                            </div>
                        ) : (
                            ...
                            <Popover>
                                ...
                                <PopoverContent className='w-80 ' align='end' sideOffset={5} >
                                    <div className='flex gap-4 space-y-2'>
                                        ...
                                        <div>
                                            <h4 className='font-medium'>Pratiksha Badgujar</h4>
